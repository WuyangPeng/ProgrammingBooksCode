...
bool	Initialize(void)
{
	...
	{
		Obstacles[i].x = /*400+_OBSTACLE_RADIUS*i;*/GetRandomNumber(_OBSTACLE_RADIUS*4, _WINWIDTH, false);
		Obstacles[i].y = /*380;*//*_WINHEIGHT/2;*/GetRandomNumber(_OBSTACLE_RADIUS*4, _WINHEIGHT, false);
	}
