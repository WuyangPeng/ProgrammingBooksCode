...
class PowerupDistCallback : public Callback   
{       
    void function(void* parent, Message* msg);
};
class PowerupSeekCallback : public Callback   
{       
    void function(void* parent, Message* msg);
};
class AppDistCallback : public Callback   
{       
    void function(void* parent, Message* msg);
};
class AttDistCallback : public Callback   
{       
    void function(void* parent, Message* msg);
};
class SafeRadiusCallback : public Callback   
{       
    void function(void* parent, Message* msg);
};
class MaxSpeedCallback : public Callback   
{       
    void function(void* parent, Message* msg);
};
...
private:
    ...
    //callbacks
    PowerupDistCallback m_powerupDistCallback;
    PowerupSeekCallback m_powerupSeekCallback;
    AppDistCallback     m_appDistCallback;
    AttDistCallback     m_attDistCallback;
    SafeRadiusCallback  m_safeRadiusCallback;
    MaxSpeedCallback    m_maxSpeedCallback;
