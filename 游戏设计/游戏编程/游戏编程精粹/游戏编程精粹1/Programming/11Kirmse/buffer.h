...
public:
    ...
    bool Set(Byte* ptr, int32 data)
    {
        return Set(ptr, (Byte*)&data, 4);
    }

    bool Set(Byte* ptr, int16 data)
    {
        return Set(ptr, (Byte*)&data, 2);
    }
    ...
    Buffer* Add(uint32 data)
    {
        return Add((Byte*)&data, 4);
    }

    Buffer* Add(int32 data)
    {
        return Add((Byte*)&data, 4);
    }

    Buffer* Add(uint16 data)
    {
        return Add((Byte*)&data, 2);
    }

    Buffer* Add(int16 data)
    {
        return Add((Byte*)&data, 2);
    }

    Buffer* Add(int8 data)
    {
        return Add((Byte*)&data, 1);
    }
    ...
    Buffer* Add(bool data)
    {
        return Add((Byte*)&data, 1);
    }

    Buffer* Add(char* string)
    {
        return Add((Byte*)string, strlen(string));
    }
    ...
    bool Peek(uint32* data)
    {
        return Peek((Byte*)data, 4);
    }

    bool Peek(int32* data)
    {
        return Peek((Byte*)data, 4);
    }
    ...
    bool PeekData(int32* data)
    {
        return PeekData((Byte*)data, 4);
    }
