...
int main(int argc, char** argv)
{
    ...
    {
        Boids[i] = new CBoid(static_cast<short>(i));
    }
...
void DisplayFunc(void)
{
    ...
    DrawBox(0, 0, static_cast<float>(20 + stringSize), 34);
    ...
    DrawBox(static_cast<float>(gWindowWidth - 20 - stringSize), 0, gWindowWidth, 34);
...
void KeyboardSpecialFunc(int key, [[maybe_unused]] int x, [[maybe_unused]] int y)
{
    switch (key)
    {
    case GLUT_KEY_UP:
...
#else
    matrix44 perspMatrix = FrustumMatrix44(-1.6f, 1.6f, -1.6f, 1.6f, 4.0f, 512.0f);
