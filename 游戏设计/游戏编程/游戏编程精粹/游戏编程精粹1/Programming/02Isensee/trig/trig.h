...
// sin( R )级数展开
// 对符合标准的编译器，将double R改成double& R
// “double”类型的非类型模板参数至少需要“/std:c++20”
#ifdef WIN32
template <double R>
struct Sine
#else
...
struct Series
{
    ...
    static inline double val()
    {
        return 1 - R * R / (2.0 * I + 2.0) /
                       (2.0 * I + 3.0) * Series<R* static_cast<int>(Continue), NxtI, NxtMaxTerms>::val();
    }
};
...
#endif
{
    ...
    {
        double Rsqr = R * R;
        return R * (1.0 - Rsqr / 2.0 / 3.0 * (1.0 - Rsqr / 4.0 / 5.0 * (1.0 - Rsqr / 6.0 / 7.0 * (1.0 - Rsqr / 8.0 / 9.0 * (1.0 - Rsqr / 10.0 / 11.0 * (1.0 - Rsqr / 12.0 / 13.0 * (1.0 - Rsqr / 14.0 / 15.0 * (1.0 - Rsqr / 16.0 / 17.0 * (1.0 - Rsqr / 18.0 / 19.0 * (1.0 - Rsqr / 20.0 / 21.0))))))))));
    }
};
...
#endif
{
    ...
    {
        double Rsqr = R * R;
        return (1.0 - Rsqr / 2.0 * (1.0 - Rsqr / 3.0 / 4.0 * (1.0 - Rsqr / 5.0 / 6.0 * (1.0 - Rsqr / 7.0 / 8.0 * (1.0 - Rsqr / 9.0 / 10.0 * (1.0 - Rsqr / 11.0 / 12.0 * (1.0 - Rsqr / 13.0 / 14.0 * (1.0 - Rsqr / 15.0 / 16.0 * (1.0 - Rsqr / 17.0 / 18.0 * (1.0 - Rsqr / 19.0 / 20.0 * (1.0 - Rsqr / 21.0 / 22.0)))))))))));
    }
};
