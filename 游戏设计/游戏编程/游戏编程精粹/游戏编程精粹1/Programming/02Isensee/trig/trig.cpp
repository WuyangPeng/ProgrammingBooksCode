...
namespace
{
    ...
    double NonRecursiveSine(double fRad)
    {
        ...
        return fRad * (1.0 - fRsqr / 2.0 / 3.0 * (1.0 - fRsqr / 4.0 / 5.0 * (1.0 - fRsqr / 6.0 / 7.0 * (1.0 - fRsqr / 8.0 / 9.0 * (1.0 - fRsqr / 10.0 / 11.0 * (1.0 - fRsqr / 12.0 / 13.0 * (1.0 - fRsqr / 14.0 / 15.0 * (1.0 - fRsqr / 16.0 / 17.0 * (1.0 - fRsqr / 18.0 / 19.0 * (1.0 - fRsqr / 20.0 / 21.0))))))))));
    }
    ...
    bool CompareFloat(double x, double y, int iSignificantDigits = 3)
    {
        ...
        sprintf_s(xBuffer, "%.*f", iSignificantDigits, x);
        sprintf_s(yBuffer, "%.*f", iSignificantDigits, y);
