...
namespace SimpleExample
{
    ...
    protected:
        ...
        void move([[maybe_unused]] double x, [[maybe_unused]] double y, [[maybe_unused]] double z)
        {
            // Code here...
        }

        void playSound([[maybe_unused]] SoundId sound, [[maybe_unused]] double volume)
        {
            // Code here...
        }

        void spawnParticles([[maybe_unused]] ParticleType type, [[maybe_unused]] int count)
        {
            // Code here...
        }
    };
...
namespace Forwarding
{
    struct SoundEngine
    {
        void play([[maybe_unused]] SoundId sound, [[maybe_unused]] double volume)
        {
        }
    };
...
namespace HelperClassBefore
{
    ...
    protected:
        ...
        void stopSound([[maybe_unused]] SoundId sound)
        {
            // Code here...
        }

        void setVolume([[maybe_unused]] SoundId sound)
        {
            // Code here...
        }
...
namespace TwoStageInit
{
    ...
    {
    public:
        void init([[maybe_unused]] ParticleSystem* particles)
        {
        }
    };
...
namespace TwoStageInitEncapsulated
{
    ...
    {
    public:
        void init([[maybe_unused]] ParticleSystem* audio)
        {
        }
    };
...
namespace UseServiceLocator
{
    ...
    protected:
        ...
        {
            ParticleSystem& particles_ = Locator::getParticles();
