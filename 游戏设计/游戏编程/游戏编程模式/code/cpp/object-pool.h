...
namespace Temp1
{
    ...
    public:
        //^omit
        void init([[maybe_unused]] double x, [[maybe_unused]] double y, [[maybe_unused]] double xVel, [[maybe_unused]] double yVel, [[maybe_unused]] int lifetime)
        {
        }
...
namespace Temp4
{
    ...
    {
    public:
        void create([[maybe_unused]] double x, [[maybe_unused]] double y)
        {
            // Forward to Particle...
        }

        void create([[maybe_unused]] double x, [[maybe_unused]] double y, [[maybe_unused]] double angle)
        {
            // Forward to Particle...
        }

        void create([[maybe_unused]] double x, [[maybe_unused]] double y, [[maybe_unused]] double xVel, [[maybe_unused]] double yVel)
        {
            // Forward to Particle...
        }
    };
