...
{
public:
    static void playSound([[maybe_unused]] int id)
    {
    }
...
{
public:
    virtual void playSound([[maybe_unused]] int soundID)
    {
        // Play sound using console audio api...
    }

    virtual void stopSound([[maybe_unused]] int soundID)
    {
...
private:
    void log([[maybe_unused]] const char* message)
    {
        // Code to log message...
    }
