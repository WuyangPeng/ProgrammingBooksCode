...
void App::onInit() {
    createDeveloperHUD();
    window()->setCaption("Toon Pixel Shader Demo");
        
    toonShader = Shader::fromFiles("toon2.vrt", "toon2.pix");
...
#   ifdef G3D_WINDOWS
      if (! FileSystem::exists("toon2.pix", false) && FileSystem::exists("G3D.sln", false)) {
