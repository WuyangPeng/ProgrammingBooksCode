...
inline objID MakeID( unsigned short segment, unsigned short offset )
{
	return (((UINT)segment)<<16) | ((UINT)offset);
}

inline unsigned short GetIDSegment( objID id )
{
	return (unsigned short)(id>>16);
}

inline unsigned short GetIDOffset( objID id )
{
	return (unsigned short)(id & 0xFFFF);
}
 ...
 */
const unsigned short c_sysSegment = 0;    // System object
const unsigned short c_cellSegment = 1;   // Cell object
const unsigned short c_playerSegment = 2; // Player object
const unsigned short c_spawnSegment = 3;  // Spawning object
const unsigned short c_projSegment = 4;   // Projectile object
const unsigned short c_paraSegment = 5;   // Parametric object
const unsigned short c_tempSegment = 6;   // Temp object
...
void DebPrint( TCHAR* first, ... ); // Print to the console
void LogPrint( TCHAR* first, ... ); // print to the log file
