	...
	m_hWnd( NULL )
{
	...
	if( m_pGlobalWindow )
	{
		throw cGameError(L"Window object already instantiated!\n" );
	}
...
void cWindow::RegisterClass( WNDCLASSEX* pWc )
{
	...
	{
		throw cGameError(L"[cWindow::RegisterClass]: Registering window class failed!\n");
	}
}
...
void cWindow::InitInstance()
{
   ...
   if ( !m_hWnd )
   {
		throw cGameError(L"[cWindow::InitInstance]: Creating window failed!\n");
   }
