...
// Windows Globals
const char	*szWndClass		= "3DLight";
const char	*szProgramName	= "3DLight Example";
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	// Create a reddish light in the scene
	vCreateLight();
