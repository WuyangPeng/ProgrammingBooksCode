...
//#																					#
//#						Initializes the 3D Environment for rendering				#
//#																					#
...
// Class name & app name
const char	*szWndClass		= "Init3D";
const char	*szProgramName	= "Init3D Example";
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    // Create a window
    hWnd = CreateWindowEx(WS_EX_TOPMOST, szWndClass, szProgramName,
