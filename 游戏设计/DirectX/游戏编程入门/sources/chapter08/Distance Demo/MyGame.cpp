...
const string APPTITLE = "Distance Demo";
...
void Game_Run(HWND window)
{
    ...
    if (d3ddev->BeginScene())
    {
		...
		Sprite_Transform_Draw(imgAsteroid, asteroid1.x, asteroid1.y, 
			asteroid1.width, asteroid1.height, asteroid1.frame, asteroid1.columns);

		Sprite_Transform_Draw(imgAsteroid, asteroid2.x, asteroid2.y, 
			asteroid2.width, asteroid2.height, asteroid2.frame, asteroid2.columns);
