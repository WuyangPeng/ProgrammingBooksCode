 ...
 * be created.
 * 工厂方法模式是一种面向对象的设计模式。
 * 像其他创建模式一样，它处理创建对象（产品）的问题，而没有指定要创建的对象的确切类。
 * Factory Method是Design Patterns一书中的模式之一，它通过定义用于创建对象的单独方法来解决此问题，
 * 然后可以重写该子类以指定将要创建的产品的派生类型。
 * <br>
 * More generally, the term Factory Method is often used to refer to any method
 * whose main purpose is creation of objects.
 * 更一般而言，术语“工厂方法”通常用于指代主要目的是创建对象的任何方法。</i>
 ...
 * 现在，客户端可以通过使用正确的标识符调用Factory的CreateObject方法来创建对象。
 * 如果ProductCreator有参数
...
#define LOKI_ENABLE_NEW_FACTORY_CODE
    ...
    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5>
    ...
    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6>
    struct FactoryImpl<AP, Id, Seq<P1, P2, P3, P4, P5, P6>> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
        ...
        virtual AP* CreateObject(const Id& id, Parm1, Parm2, Parm3, Parm4, Parm5, Parm6) = 0;
    };

    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7>
    struct FactoryImpl<AP, Id, Seq<P1, P2, P3, P4, P5, P6, P7>> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
        ...
        virtual AP* CreateObject(const Id& id, Parm1, Parm2, Parm3, Parm4, Parm5, Parm6, Parm7) = 0;
    };

    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8>
    struct FactoryImpl<AP, Id, Seq<P1, P2, P3, P4, P5, P6, P7, P8>> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
        ...
        virtual AP* CreateObject(const Id& id, Parm1, Parm2, Parm3, Parm4, Parm5, Parm6, Parm7, Parm8) = 0;
    };

    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9>
    struct FactoryImpl<AP, Id, Seq<P1, P2, P3, P4, P5, P6, P7, P8, P9>> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
        ...
        virtual AP* CreateObject(const Id& id, Parm1, Parm2, Parm3, Parm4, Parm5, Parm6, Parm7, Parm8, Parm9) = 0;
    };

    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10>
    struct FactoryImpl<AP, Id, Seq<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
        ...
        virtual AP* CreateObject(const Id& id, Parm1, Parm2, Parm3, Parm4, Parm5, Parm6, Parm7, Parm8, Parm9, Parm10) = 0;
    };

    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, typename P11>
    struct FactoryImpl<AP, Id, Seq<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11>> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
        ...
        virtual AP* CreateObject(const Id& id, Parm1, Parm2, Parm3, Parm4, Parm5, Parm6, Parm7, Parm8, Parm9, Parm10, Parm11) = 0;
    };

    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, typename P11, typename P12>
    struct FactoryImpl<AP, Id, Seq<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
        ...
        virtual AP* CreateObject(const Id& id, Parm1, Parm2, Parm3, Parm4, Parm5, Parm6, Parm7, Parm8, Parm9, Parm10, Parm11, Parm12) = 0;
    };

    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, typename P11, typename P12, typename P13>
    struct FactoryImpl<AP, Id, Seq<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13>> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
        ...
        virtual AP* CreateObject(const Id& id, Parm1, Parm2, Parm3, Parm4, Parm5, Parm6, Parm7, Parm8, Parm9, Parm10, Parm11, Parm12, Parm13) = 0;
    };

    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, typename P11, typename P12, typename P13, typename P14>
    struct FactoryImpl<AP, Id, Seq<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14>> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
        ...
        virtual AP* CreateObject(const Id& id, Parm1, Parm2, Parm3, Parm4, Parm5, Parm6, Parm7, Parm8, Parm8, Parm10, Parm11, Parm12, Parm13, Parm14) = 0;
    };

    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, typename P11, typename P12, typename P13, typename P14, typename P15>
    struct FactoryImpl<AP, Id, Seq<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15>> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
        ...
        virtual AP* CreateObject(const Id& id, Parm1, Parm2, Parm3, Parm4, Parm5, Parm6, Parm7, Parm8, Parm9, Parm10, Parm11, Parm12, Parm13, Parm14, Parm15) = 0;
    };
    ...
    template <typename AP, typename Id, typename P1, typename P2, typename P3>
    struct FactoryImpl<AP, Id, LOKI_TYPELIST_3(P1, P2, P3)> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
    ...
    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4>
    struct FactoryImpl<AP, Id, LOKI_TYPELIST_4(P1, P2, P3, P4)> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
    ...
    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5>
    struct FactoryImpl<AP, Id, LOKI_TYPELIST_5(P1, P2, P3, P4, P5)> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
    ...
    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6>
    struct FactoryImpl<AP, Id, LOKI_TYPELIST_6(P1, P2, P3, P4, P5, P6)> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
    ...
    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7>
    struct FactoryImpl<AP, Id, LOKI_TYPELIST_7(P1, P2, P3, P4, P5, P6, P7)> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
    ...
    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8>
    struct FactoryImpl<AP, Id, LOKI_TYPELIST_8(P1, P2, P3, P4, P5, P6, P7, P8)> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
    ...
    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9>
    struct FactoryImpl<AP, Id, LOKI_TYPELIST_9(P1, P2, P3, P4, P5, P6, P7, P8, P9)> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
    ...
    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10>
    struct FactoryImpl<AP, Id, LOKI_TYPELIST_10(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10)> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
    ...
    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, typename P11, typename P12>
    struct FactoryImpl<AP, Id, LOKI_TYPELIST_12(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12)> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
    ...
    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, typename P11, typename P12, typename P13>
    struct FactoryImpl<AP, Id, LOKI_TYPELIST_13(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13)> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
    ...
    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, typename P11, typename P12, typename P13, typename P14>
    struct FactoryImpl<AP, Id, LOKI_TYPELIST_14(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14)> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
    ...
    template <typename AP, typename Id, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, typename P11, typename P12, typename P13, typename P14, typename P15>
    struct FactoryImpl<AP, Id, LOKI_TYPELIST_15(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15)> : public FactoryImplBase
    {
        typedef typename TypeTraits<P1>::ParameterType Parm1;
        typedef typename TypeTraits<P2>::ParameterType Parm2;
        typedef typename TypeTraits<P3>::ParameterType Parm3;
    ...
    ///  与Loki::SingletonHolder一起使用时的单例生存期，
    ///  因为Factory在内部使用从SmallObject继承的Functors，因此必须使用单例生存期
    ...
    ///  另外，您可以通过定义宏来禁止Functor从SmallObject继承：
    /// \code LOKI_FUNCTOR_IS_NOT_A_SMALLOBJECT \endcode
    ////////////////////////////////////////////////////////////////////////////////
    template <class AbstractProduct, typename IdentifierType, typename CreatorParmTList = NullType,
    ...
    public:
        ...
        bool Register(const IdentifierType& id, ProductCreator productCreator)
        {
            return associations_.insert(typename IdToProductMap::value_type(id, productCreator)).second != 0;
        }

        template <class PtrObj, typename CreaFn>
        bool Register(const IdentifierType& id, const PtrObj& p, CreaFn fn)
        {
            ProductCreator productCreator(p, fn);
            return associations_.insert(typename IdToProductMap::value_type(id, productCreator)).second != 0;
        }
    ...
    public:
        ...
        {
            return associations_.insert(typename IdToProductMap::value_type(id, creator)).second != 0;
        }
    ...
    */
    ...
    public:
        ...
        {
            return associations_.insert(typename IdToProductMap::value_type(ti, creator)).second != 0;
        }
