...
namespace Loki
{
    ...
    // Used by AssocVector
    // 类模板AssocVectorCompare由AssocVector使用
    ////////////////////////////////////////////////////////////////////////////////
    ...
    namespace Private
    {
        ...
        class AssocVectorCompare : public C
        {
            ...
            typedef typename K first_argument_type;
    ...
    // 建立为std::map的语法替代品的关联向量，
    // 注意：AssocVector不遵守所有map的保证，最重要的是：
    // 迭代器通过insert和erase操作无效。
    // insert/erase的复杂度是O(N)而不是O(log N)。
    // value_type是std::pair<K, V>不是std::pair<const K, V>
    // 迭代器是随机的。
    ////////////////////////////////////////////////////////////////////////////////

    template <class K, class V, class C = std::less<K>, class A = std::allocator<std::pair<K, V>>>
    class AssocVector : private std::vector<std::pair<K, V>, A>, private Private::AssocVectorCompare<V, C, K>
    {
    ...
    public:
        ...
        typedef typename const std::allocator_traits<A>::value_type& const_reference;
