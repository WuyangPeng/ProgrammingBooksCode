...
String Test(String, unsigned int count, bool avoidAliasing)
{
    ...
    while (count--)
    {
        ...
        case 9:
        {
            ...
            [[maybe_unused]] auto size = test.size();
            [[maybe_unused]] auto length = test.length();
            [[maybe_unused]] auto maxSize = test.max_size();
            [[maybe_unused]] auto capacity = test.capacity();
            break;
        }
        case 10:
            // test resize
        ...
        case 14:
            // exercise empty
            {
                ...
                if (test.empty())
                    ...
                    test = String(kNonEmptyString, kNonEmptyString + strlen(kNonEmptyString));
            }
            break;
        case 15:
        {
            ...
            if (!test.empty())
            {
                auto value = test[random(0, test.size() - 1)];
                value = test.at(random(0, test.size() - 1));
            }
            break;
        }
        case 16:
    ...
    for (;;)
    {
...

        {
            ...
            typedef flex_string<
                ...
                MyString;
            const MyString tested = Test(MyString(), 1, false);
        ...
        }
        {
            ...
            typedef flex_string<
                ...
                MyString;
            static MyString sample;
            const MyString tested(Test(sample, 1, false));
            checkResults(reference, tested);
        }
        {
            srand(t);
