...
public:
    ...
    virtual ::Loki::MutexErrors Lock( void ) volatile;

    virtual ::Loki::MutexErrors TryLock( void ) volatile;

    virtual ::Loki::MutexErrors Unlock( void ) volatile;
...
public:
    ...
    void SetResult(size_t threadIndex, unsigned int total,
        unsigned int fails );
...
public:
    ...
    static size_t GetPoolSize( void );

    static void DestroyPool( void );

    void Print(size_t value, unsigned int index, unsigned int startSize) const volatile;

    void Print(size_t value, unsigned int index, unsigned int startSize) const;

    size_t GetValue(void) const volatile
    {
        return m_value;
    }
    ...
    void SetValue(size_t value) volatile;
...
public:
    ...
    {
        const_cast< Unlocker & >( that ).m_thing = nullptr;
    }
...
public:
    ...
    inline size_t GetValue(void) const volatile
    {
        return m_value;
    }

    inline size_t GetValue(void) const
    {
        return m_value;
    }

    bool DoValuesMatch(size_t value) const volatile;

    bool DoValuesMatch(size_t value) const;
