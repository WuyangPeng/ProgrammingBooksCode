...
public:
    ...
    inline static void SetConstructorToThrow(bool b)
    {
        s_throw = b;
    }

    inline static bool WillConstructorThrow(void)
    {
        return s_throw;
    }
    ...
    inline static unsigned int GetErrorCount(void)
    {
        return s_errorCount;
    }
    inline static void IncrementErrorCount(void)
    {
        ++s_errorCount;
    }
...
{
    cout << "Your compiler is " << GetCompilerName() << '.' << endl
         << endl;
