...
#define LOKI_SMALLOBJ_BENCH(FUNC, CODE_LOOP)                                          \
    ...
    int FUNC(void**, [[maybe_unused]] const int N, int loop, Timer& t, const char* s) \
    {                                                                                 \
        t.start();                                                                    \
        /****************************************************************/            \
...
#define LOKI_SMALLOBJ_BENCH_ARRAY(FUNC, CODE_DECL, CODE_NEW, CODE_DELETE)                   \
    template <class T, int TN>                                                              \
    int FUNC(void** arrv, [[maybe_unused]] const int N, int loop, Timer& t, const char* s)  \
    {                                                                                       \
        CODE_DECL;                                                                          \
        ...
        {                                                                                   \
            cout << "2. boost    :\tboost::object_pool is not tested because it's too slow" \
                 << endl                                                                    \
                 << endl;                                                                   \
            array_test_nr++;                                                                \
            return t.t();                                                                   \
