...
ALL : "$(OUTDIR)\PopPad3.exe" "$(OUTDIR)\PopPad3.bsc"


CLEAN :
	-@erase "$(INTDIR)\PopFile.obj"
	-@erase "$(INTDIR)\PopFile.sbr"
	-@erase "$(INTDIR)\PopFind.obj"
	-@erase "$(INTDIR)\PopFind.sbr"
	-@erase "$(INTDIR)\PopFont.obj"
	-@erase "$(INTDIR)\PopFont.sbr"
	-@erase "$(INTDIR)\PopPad.obj"
	-@erase "$(INTDIR)\poppad.res"
	-@erase "$(INTDIR)\PopPad.sbr"
	-@erase "$(INTDIR)\PopPrnt0.obj"
	-@erase "$(INTDIR)\PopPrnt0.sbr"
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(INTDIR)\vc60.pdb"
	-@erase "$(OUTDIR)\PopPad3.bsc"
	-@erase "$(OUTDIR)\PopPad3.exe"
...
CPP_PROJ=/nologo /MLd /W3 /WX /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "UNICODE" /D "_UNICODE" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\PopPad3.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
"$(OUTDIR)\PopPad3.bsc" : "$(OUTDIR)" $(BSC32_SBRS)
    $(BSC32) @<<
...
"$(INTDIR)\PopFile.obj"	"$(INTDIR)\PopFile.sbr" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\PopFind.obj"	"$(INTDIR)\PopFind.sbr" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\PopFont.obj"	"$(INTDIR)\PopFont.sbr" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\PopPad.obj"	"$(INTDIR)\PopPad.sbr" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\PopPrnt0.obj"	"$(INTDIR)\PopPrnt0.sbr" : $(SOURCE) "$(INTDIR)"
