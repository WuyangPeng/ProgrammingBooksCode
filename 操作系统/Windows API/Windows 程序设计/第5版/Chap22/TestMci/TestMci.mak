...
ALL : "$(OUTDIR)\TestMci.exe" "$(OUTDIR)\TestMci.bsc"


CLEAN :
	-@erase "$(INTDIR)\TestMci.obj"
	-@erase "$(INTDIR)\TestMci.res"
	-@erase "$(INTDIR)\TestMci.sbr"
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(INTDIR)\vc60.pdb"
	-@erase "$(OUTDIR)\TestMci.bsc"
	-@erase "$(OUTDIR)\TestMci.exe"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "UNICODE" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\TestMci.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
"$(OUTDIR)\TestMci.bsc" : "$(OUTDIR)" $(BSC32_SBRS)
    $(BSC32) @<<
...
"$(INTDIR)\TestMci.obj"	"$(INTDIR)\TestMci.sbr" : $(SOURCE) "$(INTDIR)"
