...
namespace FingerPaint3
{
    ...
    protected:
        ...
        void OnPolylinePointerPressed(Platform::Object^ sender, Windows::UI::Xaml::Input::PointerRoutedEventArgs^ args);
        void OnPolylineRightTapped(Platform::Object^ sender, Windows::UI::Xaml::Input::RightTappedRoutedEventArgs^ args);
        void OnMenuChangeColor(Windows::UI::Popups::IUICommand^ command);
        void OnMenuDelete(Windows::UI::Popups::IUICommand^ command);
