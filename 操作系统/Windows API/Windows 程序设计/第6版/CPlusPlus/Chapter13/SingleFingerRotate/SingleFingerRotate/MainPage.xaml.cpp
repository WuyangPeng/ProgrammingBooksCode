...
using namespace SingleFingerRotate;
...
void MainPage::OnManipulationStarting(ManipulationStartingRoutedEventArgs^ args)
{
    args->Pivot = ref new ManipulationPivot(Point((float)(image->ActualWidth / 2), 
