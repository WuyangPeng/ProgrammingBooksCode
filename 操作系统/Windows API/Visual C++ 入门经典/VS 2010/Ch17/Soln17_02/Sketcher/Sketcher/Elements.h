...
class CCurve: public CElement
{
  public:
    ...
    CCurve(CPoint* pFirst, CPoint* pSecond, COLORREF aColor);
    void AddSegment(CPoint* point);                         // Add a segment to the curve

 protected:
    std::list<CPoint*> m_Points;                            // Points defining the curve
