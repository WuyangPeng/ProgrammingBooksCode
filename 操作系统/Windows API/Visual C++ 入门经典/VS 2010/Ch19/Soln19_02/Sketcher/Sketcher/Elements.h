...
class CElement : public CObject
{
   ...
   public:
      virtual ~CElement();  
      virtual void Draw(CDC* pDC, int scale, CElement* pElement=0) {}   // Virtual draw operation
...
class CLine : public CElement
{
   ...
   public:
      ~CLine(void);
      virtual void Draw(CDC* pDC, int scale, CElement* pElement=0);     // Function to display a line
...
class CRectangle : public CElement
{
   ...
   public:
      ~CRectangle(void);
      virtual void Draw(CDC* pDC, int scale, CElement* pElement=0);     // Function to display a rectangle
...
class CCircle : public CElement
{
   ...
   public:
      ~CCircle(void);
      virtual void Draw(CDC* pDC, int scale, CElement* pElement=0);     // Function to display a circle
...
class CCurve: public CElement
{
  ...
  public:
    ~CCurve(void);
    virtual void Draw(CDC* pDC, int scale, CElement* pElement=0);     // Function to display a curve
...
class CText: public CElement
{
  ...
  public:
    ...
    virtual void Draw(CDC* pDC, int scale, CElement* pElement=0);
  ...
  protected:
    ...
    CFont font;                                            // The font to be used
