...
ON_COMMAND(ID_SOLID, &CSketcherDoc::OnSolid)
ON_COMMAND(ID_DASHED, &CSketcherDoc::OnDashed)
ON_COMMAND(ID_DOTTED, &CSketcherDoc::OnDotted)
ON_COMMAND(ID_DASHDOTTED, &CSketcherDoc::OnDashdotted)
ON_COMMAND(ID_DASHDOTDOTTED, &CSketcherDoc::OnDashdotdotted)
ON_UPDATE_COMMAND_UI(ID_SOLID, &CSketcherDoc::OnUpdateSolid)
ON_UPDATE_COMMAND_UI(ID_DASHED, &CSketcherDoc::OnUpdateDashed)
ON_UPDATE_COMMAND_UI(ID_DOTTED, &CSketcherDoc::OnUpdateDotted)
ON_UPDATE_COMMAND_UI(ID_DASHDOTTED, &CSketcherDoc::OnUpdateDashdotted)
ON_UPDATE_COMMAND_UI(ID_DASHDOTDOTTED, &CSketcherDoc::OnUpdateDashdotdotted)
END_MESSAGE_MAP()
...
void CSketcherDoc::OnSolid()
{
  m_LineStyle = PS_SOLID;
}


void CSketcherDoc::OnDashed()
{
  m_LineStyle = PS_DASH;
}


void CSketcherDoc::OnDotted()
{
  m_LineStyle = PS_DOT;
}


void CSketcherDoc::OnDashdotted()
{
  m_LineStyle = PS_DASHDOT;
}


void CSketcherDoc::OnDashdotdotted()
{
  m_LineStyle = PS_DASHDOTDOT;
}


void CSketcherDoc::OnUpdateSolid(CCmdUI *pCmdUI)
{
   // Set Checked if the current line style is solid
   pCmdUI->SetCheck(m_LineStyle==PS_SOLID);
}


void CSketcherDoc::OnUpdateDashed(CCmdUI *pCmdUI)
{
   // Set Checked if the current line style is dashed
   pCmdUI->SetCheck(m_LineStyle==PS_DASH);
}


void CSketcherDoc::OnUpdateDotted(CCmdUI *pCmdUI)
{
   // Set Checked if the current line style is dotted
   pCmdUI->SetCheck(m_LineStyle==PS_DOT);
}


void CSketcherDoc::OnUpdateDashdotted(CCmdUI *pCmdUI)
{
   // Set Checked if the current line style is dash-dotted
   pCmdUI->SetCheck(m_LineStyle==PS_DASHDOT);
}


void CSketcherDoc::OnUpdateDashdotdotted(CCmdUI *pCmdUI)
{
   // Set Checked if the current line style is dash-dot-dotted
