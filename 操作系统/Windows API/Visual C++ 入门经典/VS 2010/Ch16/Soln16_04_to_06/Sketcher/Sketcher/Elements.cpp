...
CLine::CLine(const CPoint& start, const CPoint& end, COLORREF aColor, int lineStyle):
         m_StartPoint(start), m_EndPoint(end)
{
   m_PenWidth = 1;                     // Set pen width
   m_Color = aColor;                   // Set line color
   m_LineStyle = lineStyle;            // Set the line style
...
CRectangle:: CRectangle(const CPoint& start, const CPoint& end, COLORREF aColor, int lineStyle)
{
...
CCircle::CCircle(const CPoint& start, const CPoint& end, COLORREF aColor, int lineStyle)
{
...
CCurve::CCurve(const CPoint& first, const CPoint& second, COLORREF aColor, int lineStyle)
{
   // Store the points
...
// Constructor for a circle object
CEllipse::CEllipse(const CPoint& start, const CPoint& end, COLORREF aColor, int lineStyle)
{
