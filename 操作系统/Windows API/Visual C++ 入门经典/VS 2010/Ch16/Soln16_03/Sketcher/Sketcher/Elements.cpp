...
// Constructor for a circle object
CEllipse::CEllipse(const CPoint& center, const CPoint& end, COLORREF aColor)
{
   ...
   m_EnclosingRect = CRect(start, end);
        ...
        //   Of course, you could also constructor the enclosing rectangle like this:

        //    m_EnclosingRect = CRect(2*center.x-end.x, 2*center.y-end.y, end.x, end.y);
