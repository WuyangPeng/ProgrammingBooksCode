...
/*
 You have to figure out what the following code does:
  ...
  This is decimal value 2 so that will be the output. 
  The explicit cast is essential to avoid a compiler error message. 
  This is because an unsigned value can be outside the range of type int.
  Executing the code below will show
