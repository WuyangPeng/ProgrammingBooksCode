...
BEGIN_MESSAGE_MAP(CSketcherDoc, CDocument)
  ...
  ON_COMMAND(ID_LINESTYLE_SOLID, &CSketcherDoc::OnLinestyleSolid)
  ON_COMMAND(ID_LINESTYLE_DASHED, &CSketcherDoc::OnLinestyleDashed)
  ON_COMMAND(ID_LINESTYLE_DOTTED, &CSketcherDoc::OnLinestyleDotted)
  ON_COMMAND(ID_LINESTYLE_DASHDOTDOTTED, &CSketcherDoc::OnLinestyleDashDotDotted)
  ON_COMMAND(ID_LINESTYLE_DASHDOTTED, &CSketcherDoc::OnLinestyleDashDotted)
  ON_UPDATE_COMMAND_UI(ID_LINESTYLE_SOLID, &CSketcherDoc::OnUpdateLinestyleSolid)
  ON_UPDATE_COMMAND_UI(ID_LINESTYLE_DASHED, &CSketcherDoc::OnUpdateLinestyleDashed)
  ON_UPDATE_COMMAND_UI(ID_LINESTYLE_DOTTED, &CSketcherDoc::OnUpdateLinestyleDotted)
  ON_UPDATE_COMMAND_UI(ID_LINESTYLE_DASHDOTTED, &CSketcherDoc::OnUpdateLinestyleDashDotted)
  ON_UPDATE_COMMAND_UI(ID_LINESTYLE_DASHDOTDOTTED, &CSketcherDoc::OnUpdateLinestyleDashdotdotted)
END_MESSAGE_MAP()
...
void CSketcherDoc::OnLinestyleSolid()
{
   m_LineStyle = PS_SOLID;
}


void CSketcherDoc::OnLinestyleDashed()
{
   m_LineStyle = PS_DASH;
}


void CSketcherDoc::OnLinestyleDotted()
{
   m_LineStyle = PS_DOT;
}


void CSketcherDoc::OnLinestyleDashDotDotted()
{
   m_LineStyle = PS_DASHDOTDOT;
}


void CSketcherDoc::OnLinestyleDashDotted()
{
   m_LineStyle = PS_DASHDOT;
}


void CSketcherDoc::OnUpdateLinestyleSolid(CCmdUI *pCmdUI)
{
   pCmdUI->SetCheck(m_LineStyle == PS_SOLID);
}


void CSketcherDoc::OnUpdateLinestyleDashed(CCmdUI *pCmdUI)
{
   pCmdUI->SetCheck(m_LineStyle == PS_DASH);
}


void CSketcherDoc::OnUpdateLinestyleDotted(CCmdUI *pCmdUI)
{
   pCmdUI->SetCheck(m_LineStyle == PS_DOT);
}


void CSketcherDoc::OnUpdateLinestyleDashDotted(CCmdUI *pCmdUI)
{
   pCmdUI->SetCheck(m_LineStyle == PS_DASHDOT);
}


void CSketcherDoc::OnUpdateLinestyleDashdotdotted(CCmdUI *pCmdUI)
{
   pCmdUI->SetCheck(m_LineStyle == PS_DASHDOTDOT);
}
