...
/* Third function prototype (overload).
 * Function takes two arguments, both floats.
 * Function returns no value.
 */
...
// Define the dollarsToEuros() function (overload).
void dollarsToEuros(float rate, float dollars) {
...
} // End of the dollarsToEuros() function (overload).
