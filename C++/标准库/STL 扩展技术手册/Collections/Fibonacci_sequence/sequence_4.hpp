...
inline Fibonacci_sequence::const_iterator::class_type &Fibonacci_sequence::const_iterator::operator ++()
{
	...
	{
#if defined(__GNUC__)
		std::__throw_overflow_error("Fibonacci sequence has exhausted limitations of integral type");
#else /* ? compiler */
		throw std::overflow_error("Fibonacci sequence has exhausted limitations of integral type");
#endif /* compiler */
	}
