...
public:
	Fibonacci_sequence(value_type threshold);
	~Fibonacci_sequence()
	{
...
private:
	...
	const_iterator(value_type threshold);
...
inline Fibonacci_sequence::Fibonacci_sequence(value_type threshold)
...
inline Fibonacci_sequence::const_iterator::const_iterator(value_type threshold)
	: m_i0(0)
	, m_i1(0)
	, m_threshold(threshold)
{}
