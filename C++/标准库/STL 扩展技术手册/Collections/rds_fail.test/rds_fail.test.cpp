/* /////////////////////////////////////////////////////////////////////////
 * File:        rds_fail_test.cpp
 *
 * Purpose:     Implementation file for the rds_fail_test project.
 *
...
static int main_(int /* argc */, char ** /*argv*/)
{
	...
	{
		readdir_sequence	files("/dev/include/S*.h", readdir_sequence::files);
	...
	{
		readdir_sequence	files("/dev/incpriv/S*.h");
...
int main(int argc, char *argv[])
{
    ...
    defined(__SYNSOFT_DBS_DEBUG)
        puts("rds_fail_test: " __STLSOFT_COMPILER_LABEL_STRING);
#endif /* debug */
