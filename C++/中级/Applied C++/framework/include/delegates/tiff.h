...
class apTIFFException : public apException
{
public:
  apTIFFException (std::string name="") 
    : apException ("apTIFFException: " + name) {}
};
...
class apTIFF_installer
{
public:
  static apTIFF_installer installer;
private:
  apTIFF_installer ();
};
