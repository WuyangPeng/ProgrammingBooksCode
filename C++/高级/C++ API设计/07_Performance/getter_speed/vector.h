...
inline void InlinedVector::setX(double val)
{
    mX = val;
}
inline void InlinedVector::setY(double val)
{
    mY = val;
}
inline void InlinedVector::setZ(double val)
{
    mZ = val;
}
inline double InlinedVector::getX() const
{
    return mX;
}
inline double InlinedVector::getY() const
{
    return mY;
}
inline double InlinedVector::getZ() const
{
    return mZ;
}
