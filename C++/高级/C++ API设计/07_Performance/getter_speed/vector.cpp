...
void HiddenVector::setX(double val)
{
    mX = val;
}
void HiddenVector::setY(double val)
{
    mY = val;
}
void HiddenVector::setZ(double val)
{
    mZ = val;
}
double HiddenVector::getX() const
{
    return mX;
}
double HiddenVector::getY() const
{
    return mY;
}
double HiddenVector::getZ() const
{
    return mZ;
}
