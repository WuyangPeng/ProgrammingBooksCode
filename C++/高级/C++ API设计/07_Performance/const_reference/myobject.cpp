...
namespace apibook
{
    ...
    MySubObject::MySubObject([[maybe_unused]] const MySubObject& obj)
    {
        cout << "MySubObject Copy Constructor" << endl;
    }

    MySubObject& MySubObject::operator=([[maybe_unused]] const MySubObject& obj)
    {
    ...
    MyObject::MyObject([[maybe_unused]] const MyObject& obj)
    {
        cout << "MyObject Copy Constructor" << endl;
    }

    MyObject& MyObject::operator=([[maybe_unused]] const MyObject& obj)
    {
