/*
    ...
    the following command: 
        ...
        g++ -I..\..\boost_1_32_0  -o%TEMP%\metaprogram-chapter3-example18.exe example18.cpp
...
int main()
{
    ...
    [[maybe_unused]] float rounding_error = std::abs((m2 - m).value());
