/*
    ...
    the following command: 
        ...
        g++ -I..\..\boost_1_32_0 -c -o%TEMP%\metaprogram-chapter3-example12.o example12.cpp
...
void bogus(quantity<float, mass> m, quantity<float, acceleration> a)
{
